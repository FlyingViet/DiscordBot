...
module.exports = {
    ...
    aliases: ['rankoceania', 'oceania', 'oce'],
    cooldown: 5,
    execute(message, args, con) {
        ...
        fetch('https://oc1.api.riotgames.com/lol/summoner/v4/summoners/by-name/' + summonerNam.trim() + `?api_key=${key}`, {
            ...
            return fetch('https://oc1.api.riotgames.com/lol/league/v4/entries/by-summoner/' + summonerId + `?api_key=${key}`, {method: 'get'}).then(function(response){
                return response.json();
            }).then(function(r){
